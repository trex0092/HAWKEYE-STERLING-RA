...
(function(){
  ...
  check('console(new): operator strip offers all sixteen robots', countOcc(els.operatorStrip.innerHTML, 'class="op-btn"') === 16);
...
(function(){
  ...
  check('advisor: persona picker offers fifteen advisors, Sterling default', countOcc(els.main.innerHTML, 'class="p-btn"') === 15
